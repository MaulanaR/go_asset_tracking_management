...
// RESTAPIHandler provides a convenient interface for Condition REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Condition REST API handler.
...
// GetByID is the REST API handler for `GET /api/conditions/{id}`.

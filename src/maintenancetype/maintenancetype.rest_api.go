...
// RESTAPIHandler provides a convenient interface for MaintenanceType REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the MaintenanceType REST API handler.
...
// GetByID is the REST API handler for `GET /api/maintenance_types/{id}`.
...
// Get is the REST API handler for `GET /api/maintenance_types`.
...
// Create is the REST API handler for `POST /api/maintenance_types`.
...
// UpdateByID is the REST API handler for `PUT /api/maintenance_types/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/maintenance_types/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/maintenance_types/{id}`.

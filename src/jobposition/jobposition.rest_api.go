...
// RESTAPIHandler provides a convenient interface for JobPosition REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the JobPosition REST API handler.
...
// GetByID is the REST API handler for `GET /api/job_positions/{id}`.
...
// Get is the REST API handler for `GET /api/job_positions`.
...
// Create is the REST API handler for `POST /api/job_positions`.
...
// UpdateByID is the REST API handler for `PUT /api/job_positions/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/job_positions/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/job_positions/{id}`.

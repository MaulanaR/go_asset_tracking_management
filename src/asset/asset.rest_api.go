...
// RESTAPIHandler provides a convenient interface for Asset REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Asset REST API handler.
...
// GetByID is the REST API handler for `GET /api/assets/{id}`.
...
// Get is the REST API handler for `GET /api/assets`.
...
// Create is the REST API handler for `POST /api/assets`.
...
// UpdateByID is the REST API handler for `PUT /api/assets/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/assets/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/assets/{id}`.

...
// RESTAPIHandler provides a convenient interface for EmployeeAsset REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the EmployeeAsset REST API handler.
...
// GetByID is the REST API handler for `GET /api/employee_assets/{id}`.
...
// Get is the REST API handler for `GET /api/employee_assets`.
...
// Create is the REST API handler for `POST /api/employee_assets`.
...
// UpdateByID is the REST API handler for `PUT /api/employee_assets/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/employee_assets/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/employee_assets/{id}`.

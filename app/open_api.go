...
func (o *openAPIUtil) Configure() *openAPIUtil {
	...
	o.Servers = []map[string]any{
		{"description": APP_ENV, "url": APP_URL},
	}
	o.Info.Title = "Asset Tracking Management"
	o.Info.Description = "The Asset Tracking Management allows you to perform all the operations that you do with our applications. " +
		"Asset Tracking Management is built using REST principles which ensures predictable URLs, uses standard HTTP response codes, " +
